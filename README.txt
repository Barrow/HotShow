...
----[Author]---------------------------------------------------------------------------------------
This program was created by RaptorX on September 22, 2010
...
- A Function that if the program detects a word instead of a shortcut it will wait for 
what you typed and then display the whole word/sentence at once.
---------------------------------------------------------------------------------------------------